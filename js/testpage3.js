...
function redirectToHome1() {
    window.location.href = "home_menu1.html"; 
}
...
//     if (fileName === "") {
//         resultDiv.innerHTML = "Please enter a file name.";
//         return;
//     }
    
//     // Search for the file in the directory
//     const result = findFile(directory, fileName);
    
//     // Display the result
//     if (result) {
//         resultDiv.innerHTML = `File found: ${result.fileName}`;
//     } else {
//         resultDiv.innerHTML = `File "${fileName}" not found.`;
//     }
// }

// // Recursive function to search through the directory
// function findFile(dir, fileName) {
//     for (const folder in dir) {
//         for (const item of dir[folder]) {
//             if (item.type === "file" && item.fileName.toLowerCase() === fileName.toLowerCase()) {
//                 return item;
//             }
//             if (item.type === "folder" && item.contents) {
//                 const result = findFile(item.contents, fileName); // Search recursively in subfolders
...
// function searchFile() {
//     fileNA = document.getElementById('insertName').value;
//     for (let i = 0; i < filename; i++)
//         if (filename[i] === fileNA){
